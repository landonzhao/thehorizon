 ...
 *
 * @param {object} source - Source with `understanding.category_candidates` and
 *   `understanding.framework_tags` set by Layer 5.
...
export function classifySource(source) {
  ...
  // Priority 3: preserve existing DB main_category if it's a known offensive category
