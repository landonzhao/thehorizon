...
const TAG_THEME_MAP = [
  { tags: ["mcp_exploitation"],         theme: "MCP and tool-use security" },
  { tags: ["agent_hijacking", "multi_agent_attack"], theme: "Agentic AI attack chains" },
  { tags: ["prompt_injection"],         theme: "Prompt injection attacks" },
  { tags: ["rag_attack"],               theme: "RAG and retrieval poisoning" },
  { tags: ["jailbreak"],                theme: "Jailbreak and safety bypass" },
  { tags: ["data_poisoning", "model_backdoor"], theme: "Data poisoning and backdoor attacks" },
  { tags: ["adversarial_examples"],     theme: "Adversarial examples and evasion attacks" },
  { tags: ["deepfake", "voice_cloning"], theme: "Deepfakes and synthetic media fraud" },
  { tags: ["ai_generated_phishing"],    theme: "AI-powered phishing and social engineering" },
  { tags: ["model_extraction"],         theme: "Model extraction and IP theft" },
  { tags: ["supply_chain", "ml_supply_chain", "llm_supply_chain"], theme: "AI supply chain compromise" },
  { tags: ["ai_generated_malware"],     theme: "AI-assisted malware development" },
  { tags: ["actively_exploited", "vulnerability"], theme: "Active exploitation and vulnerability disclosure" },
  { tags: ["ai_disinformation"],        theme: "AI-generated disinformation" },
  { tags: ["nation_state"],             theme: "Nation-state AI threat activity" },
  ...
  { tags: ["coding_agent_risk", "browser_agent_risk"], theme: "AI coding and browsing agent risks" },
];
