export const TAG_VERSION = "ai-threat-tags-v4.0";
...
//
// Taxonomy aligned with: OWASP LLM Top 10 (2025), MITRE ATLAS, NIST AI RMF.
export const TAG_DEFINITIONS = [
...

  {
    ...
    phrases: [
      ...
      "clean-label attack", "label flipping attack", "dataset contamination",
      "training set manipulation", "poisoning attack",
    ],
  },
  {
    ...
    phrases: [
      ...
      "model replication attack", "black-box model extraction",
      "query-based model attack", "model reconstruction attack",
    ],
  },
  {
    tag: "model_backdoor",
    ...
    phrases: [
      ...
      "malicious model weights", "poisoned model", "trojan neural network",
      "hidden trigger", "backdoor trigger",
    ],
  },
  {
    ...
    phrases: [
      ...
      "gradient leakage", "gradient inversion", "federated learning attack",
    ],
  },
  {
    ...
    phrases: [
      ...
      "physical adversarial", "universal adversarial", "adversarial texture",
      "adversarial noise", "adversarial perturbation",
    ],
  },
  {
    tag: "ml_supply_chain",
    ...
    phrases: [
      ...
      "model card poisoning", "model hub attack", "safetensors exploit",
      "pickle deserialization attack", "pretrained model attack",
      "model repository attack", "model weight attack",
    ],
  },
  {
    tag: "fine_tuning_attack",
    category: "traditional_ai_threats",
    ai_weight: 28,
    phrases: [
      "fine-tuning attack", "fine tuning attack", "malicious fine-tuning",
      "rlhf poisoning", "reinforcement learning from human feedback poisoning",
      "alignment attack", "fine-tune to bypass", "instruction tuning attack",
      "lora backdoor", "fine-tuned model backdoor", "shadow alignment",
      "unsafe fine-tuning", "fine-tuning jailbreak", "peft attack",
      "parameter efficient fine-tuning attack",
    ],
  },
...

  {
    ...
    phrases: [
      ...
      "prompt smuggling", "context injection", "goal hijacking",
      "task hijacking", "instruction override",
      "ignore previous instructions", "ignore all previous",
      "direct prompt injection", "stored prompt injection",
  ...
  },
  {
    ...
    phrases: [
      ...
      "jailbreak llm", "jailbreak prompt", "roleplay jailbreak",
      "persona jailbreak", "character break", "skeleton key attack",
      "bad likert judge", "roleplay attack", "in-context jailbreak",
      "do anything now", "developer mode exploit",
    ],
  },
  {
    ...
    phrases: [
      ...
      "moderation bypass", "refusal bypass", "harm filter bypass",
      "safety training bypass", "output restriction bypass",
      "policy bypass llm", "helpfulness exploit",
    ],
  },
  {
    tag: "rag_poisoning",
    ...
    phrases: [
      ...
      "knowledge base poisoning", "retrieval augmented generation attack",
      "context window poisoning via retrieval", "corpus poisoning",
    ],
  },
  {
    ...
    phrases: [
      ...
      "context window leakage", "cross-session data leakage",
      "conversation history exposure", "cross-tenant data exposure",
      "system prompt disclosure", "pii leakage via llm",
      "llm information disclosure",
    ],
  },
  {
    tag: "llm_insecure_output",
    category: "llm_threats",
    ai_weight: 25,
    phrases: [
      "insecure output handling", "llm output injection",
      "xss via llm", "sql injection via llm", "code injection via llm output",
      "llm output validation", "unsafe llm output",
      "server-side template injection via llm", "llm-generated malicious output",
      "unsanitized llm output", "downstream injection",
    ],
  },
  {
    tag: "llm_tool_abuse",
    ...
    phrases: [
      ...
      "function injection", "llm function calling attack",
  ...
  },
  {
    ...
    phrases: [
      ...
      "ai assistant vulnerability", "llm integration flaw",
    ],
  },
  {
    tag: "ai_dos",
    ...
    ai_weight: 20,
    phrases: [
      "denial of service llm", "llm denial of service", "llm dos",
      "sponge attack", "sponge example",
      "prompt bombing", "resource exhaustion llm", "token flooding",
      "unbounded consumption llm", "adversarial token flooding",
      "context window flooding", "llm resource abuse",
...

  {
    ...
    phrases: [
      ...
      "agentic workflow", "agent swarm", "compound ai",
      "llm orchestration attack", "agent pipeline attack",
  ...
  },
  {
    ...
    phrases: [
      ...
      "mcp injection", "mcp rug pull", "poisoned mcp server",
      "mcp tool poisoning", "mcp server hijack", "mcp server attack",
      "mcp security", "mcp threat",
    ],
  },
  {
    tag: "llm_excessive_agency",
    category: "agentic_ai_threats",
    ai_weight: 30,
    phrases: [
      "excessive agency", "llm excessive permissions", "over-permissioned agent",
      "agent privilege creep", "unintended action by agent", "agent over-reach",
      "agent autonomy risk", "llm autonomous action risk",
      "excessive llm capabilities", "agent scope creep",
      "llm06", "owasp llm06",
    ],
  },
  {
    ...
    phrases: [
      ...
      "agent capability abuse", "unauthorized agent action",
    ],
  },
  {
    ...
    phrases: [
      ...
      "agent state manipulation", "persistent memory attack",
      "agent conversation injection", "agent memory tampering",
    ],
  },
  {
    ...
    phrases: [
      ...
      "ai code generation risk", "swe-agent vulnerability",
      "agentic coding security", "ai programming assistant risk",
      "ai developer tool attack", "copilot attack",
    ],
  },
  {
    ...
    phrases: [
      ...
      "computer-use vulnerability", "computer-use attack",
      "gui agent attack", "web scraping agent risk",
      "operator attack", "computer use exploit",
    ],
  },
...

  {
    ...
    phrases: [
      ...
      "ai-generated face", "gan-generated image fraud",
      "liveness attack", "biometric spoofing ai",
      "face generation attack", "synthetic face fraud",
    ],
  },
  {
    tag: "voice_cloning",
    ...
    phrases: [
      ...
      "ai voice fraud", "voice synthesis attack",
      "audio cloning attack",
    ],
  },
  {
    tag: "synthetic_media",
    ...
    phrases: [
      ...
      "synthetic identity", "ai-generated identity document",
      "synthetic document fraud", "ncii", "non-consensual intimate imagery",
    ],
  },
  {
    tag: "ai_phishing",
    ...
    phrases: [
      ...
      "ai-crafted phishing", "personalized phishing at scale",
      "ai-targeted phishing", "llm phishing campaign",
  ...
  },
  {
    ...
    phrases: [
      ...
      "ai fraud", "generative ai scam", "ai-powered scam",
      "ai impersonation attack", "deepfake scam",
      "ai voice fraud call",
    ],
  },
  {
    ...
    phrases: [
      ...
      "llm-generated ransomware", "ai-enabled malware",
      "ai-assisted shellcode", "polymorphic malware ai",
      "autonomous malware ai", "llm exploit generation",
    ],
  },
  {
    ...
    phrases: [
      ...
      "ai-generated fake news", "synthetic narrative",
      "computational propaganda", "llm-generated propaganda",
    ],
  },
...

  {
    ...
    phrases: [
      ...
      "ai-based security monitoring", "llm-based detection",
    ],
  },
  {
    tag: "soc_automation",
    ...
    phrases: [
      ...
      "ai-powered soc", "llm security analyst", "automated threat response",
    ],
  },
  {
    tag: "threat_hunting",
    ...
    phrases: [
      ...
      "ai-powered threat hunt", "automated threat hunting",
    ],
  },
  {
    ...
    phrases: [
      ...
      "llm-assisted cti", "ml threat intelligence",
    ],
  },
  {
    ...
    phrases: [
      ...
      "llm-assisted reverse engineering", "ai-powered malware detection",
    ],
  },
  {
    ...
    phrases: [
      ...
      "llm code review security", "ai fuzzing", "ai vulnerability scanning",
    ],
  },
  {
    tag: "defensive_ai",
    ...
    phrases: [
      ...
      "ai safety benchmark", "model robustness evaluation",
  ...
  },
  {
    ...
    phrases: [
      ...
      "software supply chain attack", "third-party component attack",
      "open source poisoning", "npm attack", "pypi attack",
    ],
  },
  {
    ...
    phrases: [
      ...
      "api key leakage", "oauth token theft", "service account compromise",
      "token hijacking", "credential harvesting",
    ],
  },
  {
    ...
    phrases: [
      ...
      "critical national infrastructure", "cni security", "power grid attack",
    ],
  },
  {
  ...
  {
    tag: "healthcare_sector",
    category: null,
    ai_weight: 0,
    phrases: [
      "healthcare sector", "health sector", "medical ai", "clinical ai system",
      "medical device ai", "health data breach", "patient record exposure",
      "hospital attack", "electronic health record attack", "clinical data leak",
    ],
  },
  {
  ...
  },
  {
    ...
    ai_weight: 0,
    phrases: [
      "arxiv", "research paper", "academic paper", "conference paper",
      "ieee", "acm dl", "acm ccs", "usenix security", "ieee s&p",
      "ndss", "black hat research", "defcon research",
    ],
  },
  {
    tag: "policy",
    ...
    phrases: [
      ...
      "nist ai rmf", "nist ai 600", "iso 42001", "ai executive order",
      "ai safety framework", "frontier ai regulation", "bletchley declaration",
      "ai safety summit", "model evaluation requirement",
      "pre-deployment testing", "ai act",
    ],
  },
];
...
export const CONTEXT_TAGS = [
  ...
  "financial_sector", "government_sector", "healthcare_sector",
  "singapore_relevance", "asean_relevance", "research", "policy",
];
